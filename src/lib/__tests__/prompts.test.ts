...
describe('PROMPTS registry', () => {
  it('contains all 29 expected prompt IDs', () => {
    const expectedIds = [
      'transform.default',
      'qualitative.default',
    ...
    expect(Object.keys(PROMPTS)).toHaveLength(29);
  });
...
describe('getPrompt', () => {
  ...
  it('returns non-empty strings for all 29 registered prompts', () => {
